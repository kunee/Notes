...
public class NotesDatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String NOTE_TABLE_INSERT = String.format("INSERT INTO %s (%s) VALUES ('%s')", NotesContract.Notes.TABLE_NAME, NotesContract.Notes.COLUMN_NOTE, "This is an example note!");
